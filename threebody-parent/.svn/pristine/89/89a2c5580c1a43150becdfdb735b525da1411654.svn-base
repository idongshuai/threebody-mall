package net.dongshuai.user.service.impl;
...
import net.dongshuai.mapper.TbAddressMapper;
import net.dongshuai.pojo.TbAddress;
import net.dongshuai.pojo.TbAddressExample;
import net.dongshuai.pojo.TbAddressExample.Criteria;
import net.dongshuai.user.service.AddressService;
