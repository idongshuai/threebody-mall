 ...
 * 处理script资源的taglib
 */
public class ScriptWebOfficeControllTag extends TagSupport {
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			String outputSrc = "/wpswebjs/" + locale + "/" + src + "?" + StaticResourceVersionHolder.getVersion(src);
	...
	private void buildScript(String locale) throws Exception{
		...
		String scriptSrc = "wpswebjs/" + locale + "/" + src;
		String fileDir = AppConfig.getParam(ConfigKeys.WEB_ROOT_PATH) + scriptSrc;
		fileDir = fileDir.replace("/", File.separator);
