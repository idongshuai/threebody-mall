...
Schema.addCategory({
	name: "uml_sequence",
	text: "<@i18n resource='schema.category.uml.sequence'/>",
	dataAttributes: []
});
...
Schema.addShape({
	name: "sequenceObject",
	title: "<@i18n resource='schema.uml.sequence.umlobject'/>",
...
Schema.addShape({
	name: "sequenceEntity",
	title: "<@i18n resource='schema.uml.sequence.entity'/>",
	category: "uml_sequence",
	props: {
		w: 40,
		h: 40
...
Schema.addShape({
	...
	title: "<@i18n resource='schema.uml.sequence.control'/>",
	category: "uml_sequence",
	props: {
		w: 40,
		h: 40
...
Schema.addShape({
	...
	title: "<@i18n resource='schema.uml.sequence.boundary'/>",
	category: "uml_sequence",
	props: {
		w: 50,
		h: 40
...
Schema.addShape({
	...
	title: "<@i18n resource='schema.uml.sequence.timersignal'/>",
	category: "uml_sequence",
	props: {
		w: 30,
		h: 30
...
Schema.addShape({
	...
	title: "<@i18n resource='schema.uml.sequence.constraint'/>",
	category: "uml_sequence",
	attribute: {
		linkable: false
	},
...
Schema.addShape({
	...
	title: "<@i18n resource='schema.uml.sequence.activation'/>",
	category: "uml_sequence",
	props: {
		w: 30,
		h: 100
...
Schema.addShape({
	...
	title: "<@i18n resource='schema.uml.sequence.lifeline'/>",
	category: "uml_sequence",
	props: {
		w: 70,
		h: 140
...
Schema.addShape({
	...
	title: "<@i18n resource='schema.uml.sequence.deletion'/>",
	category: "uml_sequence",
	props: {
		w: 40,
		h: 40
