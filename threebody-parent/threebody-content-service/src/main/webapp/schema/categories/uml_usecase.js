...
Schema.addCategory({
	name: "uml_usecase",
	text: "<@i18n resource='schema.category.uml.usecase'/>",
	dataAttributes: []
});
/**
 * 1. Actor
...
Schema.addShape({
	name: "actor",
	title: "<@i18n resource='schema.uml.usecase.actor'/>",
...
Schema.addShape({
	name: "useCase",
	title: "<@i18n resource='schema.uml.usecase.ucase'/>",
	category: "uml_usecase",
	props: {
		w: 100,
		h: 70
...
Schema.addShape({
	name: "ovalContainer",
	title: "<@i18n resource='schema.uml.usecase.ocontainer'/>",
	category: "uml_usecase",
	props: {
		w: 150,
		h: 220
...
Schema.addShape({
	...
	title: "<@i18n resource='schema.uml.usecase.rcontainer'/>",
	category: "uml_usecase",
	props: {
		w: 300,
		h: 240
