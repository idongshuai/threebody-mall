...
Schema.addCategory({
	name: "uml_common",
	text: "<@i18n resource='schema.category.uml.common'/>",
	dataAttributes: []
});
...
Schema.addShape({
	name: "package",
	title: "<@i18n resource='schema.uml.common.package'/>",
	category: "uml_common",
	props: {
		w: 210,
		h: 150
	...
	textBlock: [
		{position: {x: "10", y: "0", w: "w*0.7-10", h: "25"}, text: "<@i18n resource='schema.uml.common.package'/>"},
		{position: {x: "10", y: "30", w: "w-20", h: "h-35"}, text: "<@i18n resource='schema.uml.common.package.attri'/>", fontStyle: {bold: false}}
	],
	path: [
		{
			actions: [
...
Schema.addShape({
	...
	title: "<@i18n resource='schema.uml.common.combinedfragment'/>",
	category: "uml_common",
	props: {
		w: 400,
		h: 280
	...
	textBlock: [
		{position: {x: "10", y: "30", w: "w-20", h: "h-35"}, text: "<@i18n resource='schema.uml.common.combinedfragment.text'/>"},
		{position: {x: "10", y: "0", w: "w*0.3-10", h: "25"}, text: "<@i18n resource='schema.uml.common.combinedfragment.title'/>", fontStyle: {vAlign: "middle"}}
	],
	path: [
		{
...
Schema.addShape({
	name: "umlNote",
	title: "<@i18n resource='schema.uml.common.note'/>",
	category: "uml_common",
	attribute: {
		linkable: false
	},
...
Schema.addShape({
	name: "umlText",
	title: "<@i18n resource='schema.uml.common.label'/>",
	category: "uml_common",
	attribute: {
		linkable: false
	},
	...
	anchors: [],
	textBlock: [{position: {x: 0, y: 0, w: "w", h: "h"}, text: "<@i18n resource='schema.uml.common.label'/>"}],
	path: [
		{
			lineStyle: {lineWidth: 0},
			fillStyle: {
