...
Schema.addCategory({
	name: "epc",
	text: "<@i18n resource='schema.category.epc'/>",
	dataAttributes: [
...
Schema.addShape({
	name: "event",
	title: "<@i18n resource='schema.epc.event'/>",
	category: "epc",
	props: {
		w: 100,
		h: 70
...
Schema.addShape({
	name: "method",
	title: "<@i18n resource='schema.epc.function'/>",
	category: "epc",
	props: {
		w: 100,
		h: 70
...
Schema.addShape({
	name: "procedure",
	title: "<@i18n resource='schema.epc.procedure'/>",
	category: "epc",
	props: {
		w: 100,
		h: 70
...
Schema.addShape({
	name: "epcData",
	title: "<@i18n resource='schema.epc.data'/>",
	category: "epc",
	props: {
		w: 100,
		h: 70
...
Schema.addShape({
	name: "form",
	title: "<@i18n resource='schema.epc.form'/>",
	category: "epc",
	props: {
		w: 100,
		h: 70
...
Schema.addShape({
	name: "forms",
	title: "<@i18n resource='schema.epc.forms'/>",
	category: "epc",
	props: {
		w: 100,
		h: 70
...
Schema.addShape({
	name: "database",
	title: "<@i18n resource='schema.epc.database'/>",
	category: "epc",
	props: {
		w: 100,
		h: 70
...
Schema.addShape({
	name: "and",
	title: "<@i18n resource='schema.epc.and'/>",
	category: "epc",
	props: {
		w: 40,
		h: 40
...
Schema.addShape({
	name: "or",
	title: "<@i18n resource='schema.epc.or'/>",
	category: "epc",
	props: {
		w: 40,
		h: 40
...
Schema.addShape({
	name: "xor",
	title: "<@i18n resource='schema.epc.xor'/>",
	category: "epc",
	props: {
		w: 40,
		h: 40
